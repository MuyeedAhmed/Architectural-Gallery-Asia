...
?>
<div class="search-to-remove">
	<h2>Select structure to Remove</h2>
	<?php
		if($_POST["tsearch"] != ""){
	...
	?>
		<form name = "choose to remove" method = "post" action = "Remove Structure.php">
...
.search-to-remove input[type="submit"]{
    width: 100px;
    padding: 3px;
    color: white;
...
.search-to-remove input[type="submit"]:hover{
